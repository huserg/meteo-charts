<nav x-data="{ open: false }" class="bg-gray-900 border-b border-gray-900 dark:bg-black dark:border-dark-blue">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-50 hover:text-indigo-500 hover:border-gray-300 focus:text-indigo-500 focus:border-gray-300 focus:outline-none transition duration-150 ease-in-out dark:text-light dark:hover:text-light-blue dark:hover:border-light-blue dark:focus:text-blue dark:focus:border-blue ">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')" class="hover:bg-indigo-500 hover:text-gray-50"
